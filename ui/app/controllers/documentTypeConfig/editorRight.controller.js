sap.ui.controller('app.controllers.documentTypeConfig.editorRight', {
    onInit: function() {
        var _self = this;
    },
            ...
            rightButtons: [{
                ...
                onPress: function() {
                    if (_self.coreServices.hasChanged) {
                        ...
                        window.location = '#/library?cadastro=documentTypeConfig';
                    }
                },
                isButton: true,
        ...
        this.dialog = $.baseDialog({
            ...
            buttons: [{
                ...
                click: function() {
                    ...
                    Data.endpoints.documentTypeConfig[endpoint].post(item).success(function(_data) {
                        $.baseToast({
    ...
    renderTabs: function() {
        ...
        this.view.tabs.ctrl = this.view.tabs.bindBaseTabs({
            tab: [{
                viewName: "app.views.documentTypeConfig.configuration"
            }],
    ...
    validate: function(item) {
        ...
        var config = item.docType !== "" && item.docTypeDescription !== "" && item.numberRange !== "" && item.validFrom !== "";
